...
<p style="font-size:15px;line-height:1.6;color:#374151;">Voici le recapitulatif de votre diagnostic IA pour le metier de <strong>${metier}</strong>.</p>
...
<td style="text-align:center;padding:8px;"><div style="font-size:32px;font-weight:700;color:#111827;">${totalTasks}</div><div style="font-size:11px;color:#6B7280;margin-top:4px;">Taches</div></td>
...
<p style="font-size:14px;font-weight:600;color:#111827;margin-bottom:12px;">Vos 3 taches les plus impactantes :</p>
${tasksHtml}
<div style="background:#2563EB;border-radius:12px;padding:24px;margin:32px 0;text-align:center;">
<p style="font-size:15px;color:white;font-weight:600;margin:0 0 8px 0;">Passer a la mise en oeuvre ?</p>
...
<p style="font-size:12px;color:#9CA3AF;margin-top:32px;">Diagnostic genere par DECLIC — <a href="https://lecko.fr" style="color:#2563EB;">lecko.fr</a></p>
</body></html>`;
